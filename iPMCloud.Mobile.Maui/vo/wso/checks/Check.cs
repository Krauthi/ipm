...
namespace iPMCloud.Mobile
{
    public class Check : ICloneable
    {
        ...
        public static Border GetBadgeFrame(int value, double minsize = 50)
        {
        ...
        public static Border GetQuestMain_3(CheckLeistungAntwort quest)
        {
            ...
            quest.stack_Badge = new HorizontalStackLayout
            {
                Padding = new Thickness(0),
        ...
        public static VerticalStackLayout GetSignElement()
        {
            ...
            var stack = new VerticalStackLayout { HorizontalOptions = LayoutOptions.Fill };
